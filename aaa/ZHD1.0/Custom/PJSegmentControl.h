...
enum HMSelectionIndicatorMode {
    HMSelectionIndicatorResizesToStringWidthTop = 0, // Indicator width will only be as big as the text width
    HMSelectionIndicatorResizesToStringWidthBottom = 1, // Indicator width will only be as big as the text width
    HMSelectionIndicatorFillsSegmentTop = 2, // Indicator width will fill the whole segment
    HMSelectionIndicatorFillsSegmentBottom = 3 // Indicator width will fill the whole segment
};

@interface PJSegmentControl : UIControl
