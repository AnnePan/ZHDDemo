...
@implementation PJSegmentControl
...
- (void)setDefaults {
    ...
    self.selectionIndicatorMode = HMSelectionIndicatorResizesToStringWidthTop;
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidthTop || self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidthBottom) {
        ...
        if (self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidthTop) {
