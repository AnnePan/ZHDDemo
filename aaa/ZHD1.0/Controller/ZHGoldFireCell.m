...
//    ZHRecommendDetailVc *nextVc = [[ZHRecommendDetailVc alloc] initWithUser:_user];
//    [self.viewController pushViewController:nextVc animated:YES];
...
//        UITapGestureRecognizer *labTap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(_contextBtnAction:)];
//        labTap.numberOfTouchesRequired = 1;
//        labTap.numberOfTapsRequired = 1;
//        [_contextLab addGestureRecognizer:labTap];
